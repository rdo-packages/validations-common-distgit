...
BuildRequires:  ((python3dist(ansible) or ansible-core >= 2.11) and (python3dist(ansible) or ansible-core < 2.14.2))
BuildRequires:  python3-PyYAML >= 3.13
BuildRequires:  python3-validations-libs >= 1.2.0

Requires:       ((python3dist(ansible) or ansible-core >= 2.11) and (python3dist(ansible) or ansible-core < 2.14.2))
